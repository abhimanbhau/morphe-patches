...
import app.morphe.patches.all.disableanalytics.disableAnalyticsPatch
...
val unlockPremiumPatch = bytecodePatch(
    ...
    execute {
        val lambda = ExistPurchaseLambdaFingerprint.match().method
        ...
        GetPurchasedFingerprint.match().method.addInstructions(
            0,
            """
                sget-object v0, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;
                return-object v0
